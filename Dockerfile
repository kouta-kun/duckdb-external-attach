...
RUN git clone https://github.com/kouta-kun/duckdb-external-attach; cd duckdb-external-attach; git clone https://github.com/duckdb/duckdb; cd duckdb; git pull --tags && git checkout v0.6.0 && cd .. && make;
